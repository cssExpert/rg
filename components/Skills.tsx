...
*/
const skillColors: Record<string, {
  ...
  js:        { bg: "rgba(247,223,30,0.15)",   text: "#f7df1e", icon: "JS",
               lightBg: "rgba(122,100,0,0.10)", lightText: "#7a6400" },
  ts:        { bg: "rgba(49,120,198,0.15)",   text: "#3178c6", icon: "TS" },
  react:     { bg: "rgba(97,218,251,0.15)",   text: "#61dafb", icon: "Re",
               lightBg: "rgba(3,105,161,0.10)", lightText: "#0369a1" },
  next:      { bg: "rgba(206,255,0,0.15)",    text: "#ceff00", icon: "Nx",
               lightBg: "rgba(82,114,0,0.10)", lightText: "#527200" },
  tailwind:  { bg: "rgba(56,189,248,0.15)",   text: "#38bdf8", icon: "Tw",
               lightBg: "rgba(3,105,161,0.10)", lightText: "#0369a1" },
...
function SkillCard({ skill, index }: { skill: (typeof skills)[0]; index: number }) {
  ...
  const base = skillColors[skill.icon] ?? { bg: "rgba(206,255,0,0.1)", text: "#ceff00", icon: skill.name.slice(0, 2) }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <p className="font-sans font-semibold text-sm text-[var(--text)]">
          {skill.name}
        </p>
        <span
          suppressHydrationWarning
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            className="font-sans text-[var(--text-muted)] mt-4 max-w-xl mx-auto"
          >
        ...
        >
          <p className="font-heading text-2xl sm:text-3xl text-[var(--text)] mb-2">
